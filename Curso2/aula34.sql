...
DELIMITER $$
USE `insight_places`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `novoAluguel_34`(vAluguel VARCHAR(10), 
...
CALL novoAluguel_34('10007','Victorino Vila','8635','2023-03-20','2023-04-04',40);
CALL novoAluguel_34('10007','Júlia Pires','8635','2023-03-20','2023-04-04',40);
CALL novoAluguel_34('10007','Luana Moura','8635','2023-03-20','2023-04-04',40);